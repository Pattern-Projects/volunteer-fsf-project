...
class TestCampForms(TestCase):
    ...
    def test_can_create_a_camp_with_minimum_details(self):
        form = CampForm({'title': 'A camp', 'country': 'Ireland', 'organisation': 'Volunteer-Ireland', 'description': 'A camp','positions' : 0, 'positions_male' : 0, 'positions_female' : 0, 'positions_other' : 0, 
